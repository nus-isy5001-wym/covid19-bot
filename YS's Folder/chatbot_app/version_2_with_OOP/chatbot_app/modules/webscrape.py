...
class Webscrape():
    ...
    def statusScrapper(self):
        ...
        html_soup = get(url)
        print("Worldometer website response status: ",html_soup.status_code)
        ...
        col = ['country', 'diagnosed', 'new_cases', 'death',
            'new_death', 'discharged', 'active', 'critical','nonsense1','nonsense2','first_case','nonsense2','death_rate']
    ...
    def newsScrapper(self):
        #MOHHeadlines.objects.all().delete()
