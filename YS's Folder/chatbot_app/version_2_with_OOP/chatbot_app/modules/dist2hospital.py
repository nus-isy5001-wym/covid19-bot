...
class Dist2Hospital(Server):
    def __init__(self, request):
        ...
        #self.__key = os.environ['AIzaSyCpqFU-7MTe4GSgFzuobfscIYm1E-tLrgY']
        #self.gmaps = googlemaps.Client(key = __key)
    ...
    def dist2hospital(self):
        ...
        self.text1 = f"Your location is {address_}, Singapore. Nearest {premise_} to you that I found is at {premise_query[solution].Name}. You are {distance_gmap:.1f}km away from it, it will take approximately {duration_gmap:.0f}min for you to reach there if you depart by car now."
